      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="content table-responsive" v-if="!submitted">
            <form @submit.prevent="handleUpdate({idCategory})" enctype="multipart/form-data">
              <table class="table table-hover table-striped ">
                ...
                <tr>
                  ...
                  <td><input type="text" name="description"  required v-model="categories.description"  class="form-control" placeholder="Mời mô tả"></td>
                </tr>
                <tr>
                  <td class="tdcss"></td>
                  <td>
...
export default {
name: "CategoriesEdit",components:{
    Menu
  },
  data(){
    return{
    ...
    getCategory(id){
      axios.get('http://35.240.134.17:8888/category/'+id).
      then((resp)=>{
    ...
    handleUpdate(id){
      ...
      axios.put('http://35.240.134.17:8888/category/'+this.idCategory,data).
      then((resp)=>{
        console.log(resp);
