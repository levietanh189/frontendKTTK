              ...
              <form @submit.prevent="handelAdd" enctype="multipart/form-data">
                <table class="table table-hover table-striped ">
                  ...
                  <tr>
                    ...
                    <td><input type="file" name="image" id="image"  required @change="Images_onFileChanged"  class="form-control"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="category" v-model="products.idCategory" class="form-control" required>
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="supplier" v-model="products.idSupplier" class="form-control" required>
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="newsKindId" v-model="products.idGender" class="form-control" required>
...
components:{
  ...
  data(){
    ...
    handelAdd(){
      ...
      mypostparameters.append('idCategory',this.products.idCategory);
      mypostparameters.append('idSupplier',this.products.idSupplier);
      mypostparameters.append('idGender',this.products.idGender);


      axios.post('http://35.240.134.17:8888/product',mypostparameters).
      then((resp)=>{
        console.log(resp)
        this.submitted = true;
      })
